# users/management/page_data.py
# (Content same as provided in previous response)

PAGES_DATA = [
    # --- Dashboard ---
    {'module': 'Dashboard', 'name': 'Dashboard View', 'codename': 'dashboard_view', 'url_name': '/'},

    # --- Administration ---
    {'module': 'Administration', 'name': 'Manage Role', 'codename': 'manage_role', 'url_name': '/administration/manage-role'},
    ...
    # --- Employee Management ---
    {'module': 'Employee Management', 'name': 'Department', 'codename': 'manage_department', 'url_name': '/employee-management/department'},
    ...
    {'module': 'Leave Management', 'name': 'Manage Holiday', 'codename': 'manage_holiday', 'url_name': '/leave-management/setup/manage-holiday'},
    ...
    # --- Leave Management: Application & Report ---
    ...
    # --- Attendance: Setup ---
    {'module': 'Attendance', 'name': 'Manage Work Shift', 'codename': 'manage_shift', 'url_name': '/attendance/setup/manage-work-shift'},
    ...
    # --- Payroll: Setup ---
    {'module': 'Payroll', 'name': 'Tax Rule Setup', 'codename': 'tax_rule_setup', 'url_name': '/payroll/setup/tax-rule-setup'},
    ...
    # --- Performance ---
    {'module': 'Performance', 'name': 'Performance Category', 'codename': 'performance_category', 'url_name': '/performance-category'},
    ...
    # --- Recruitment ---
    {'module': 'Recruitment', 'name': 'Job Post', 'codename': 'job_post', 'url_name': '/job-post'},
    {'module': 'Recruitment', 'name': 'Job Candidate', 'codename': 'job_candidate', 'url_name': '/job-candidate'},

    # --- Training ---
    {'module': 'Training', 'name': 'Training Type', 'codename': 'training_type', 'url_name': '/training-type'},
    ...
    # --- Award ---
    {'module': 'Award', 'name': 'Award Management', 'codename': 'manage_award', 'url_name': '/award'},

    # --- Notice Board ---
    {'module': 'Notice Board', 'name': 'Notice Management', 'codename': 'manage_notice', 'url_name': '/notice'},

    # --- Settings ---
    {'module': 'Settings', 'name': 'General Settings', 'codename': 'general_settings', 'url_name': '/settings'},
]